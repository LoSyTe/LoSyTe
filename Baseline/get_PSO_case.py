...
#需要提供super_case_path、config_path，返回synth_time
def case_generate(super_case_path, config_path):
    case_path_1 = './baseline_case_and_bug_generation/PSO_case/case_1'
    case_path_2 = './baseline_case_and_bug_generation/PSO_case/case_2'
    case_path_3 = './baseline_case_and_bug_generation/PSO_case/case_3'
    case_path_4 = './baseline_case_and_bug_generation/PSO_case/case_4'
    case_path_5 = './baseline_case_and_bug_generation/PSO_case/case_5'
    case_path_6 = './baseline_case_and_bug_generation/PSO_case/case_6'
    # case_path_7 = './baseline_case_and_bug_generation/PSO_case/case_7'
    # case_path_8 = './baseline_case_and_bug_generation/PSO_case/case_8'
    # case_path_9 = './baseline_case_and_bug_generation/PSO_case/case_9'
    # case_path_10 = './baseline_case_and_bug_generation/PSO_case/case_10'
    ...
    # 启动两个并行的 verismith 进程
    process1 = subprocess.Popen(f'verismith fuzz -c {config_path} -n 2 -o {case_path_1} -k --no-equiv --no-reduction', shell=True)
    process2 = subprocess.Popen(f'verismith fuzz -c {config_path} -n 2 -o {case_path_2} -k --no-equiv --no-reduction', shell=True)
    process3 = subprocess.Popen(f'verismith fuzz -c {config_path} -n 2 -o {case_path_3} -k --no-equiv --no-reduction', shell=True)
    process4 = subprocess.Popen(f'verismith fuzz -c {config_path} -n 2 -o {case_path_4} -k --no-equiv --no-reduction', shell=True)
    process5 = subprocess.Popen(f'verismith fuzz -c {config_path} -n 2 -o {case_path_5} -k --no-equiv --no-reduction', shell=True)
    process6 = subprocess.Popen(f'verismith fuzz -c {config_path} -n 2 -o {case_path_6} -k --no-equiv --no-reduction', shell=True)
