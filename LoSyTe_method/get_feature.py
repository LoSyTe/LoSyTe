...
def extract_features(ast):
    ...
    for desc in ast.description.definitions:
        if isinstance(desc, ModuleDef):
            ...
            # features['WhileStatement'] += count_WhileStatement(desc)
            # features['CaseStatement'] += count_CaseStatement(desc)
            # features['Constant'] += count_Constant(desc)
            # features['IntConst'] += count_IntConst(desc)
            # features['FloatConst'] += count_FloatConst(desc)
            ...
            # features['LConcat'] += count_LConcat(desc)
            features['Partselect'] += count_Partselect(desc)
            # features['Pointer'] += count_Pointer(desc)
            ...
            # features['Value'] += count_Value(desc)
            # features['Lvalue'] += count_Lvalue(desc)
            # features['Rvalue'] += count_Rvalue(desc)
